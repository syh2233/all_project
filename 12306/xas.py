...
def switch_ip(ips=None, colist=None):
    global set_proxy
    if ips:
        # 设置proxy
        ...
        if colist == 1:
            ...
            try:
                ...
                tab1.wait(1)
                # 提示框
                txt = tab1.handle_alert()
                print("提示框", txt)
                tab1.handle_alert(accept=False)
            ...
            try:
                ...
                tab2.wait(1)
                # 提示框
                txt = tab2.handle_alert()
                print("提示框", txt)
                tab2.handle_alert(accept=False)
                tab2 = browser2.new_tab()
            ...
            try:
                ...
                tab3.wait(1)
                # 提示框
                txt = tab3.handle_alert()
                print("提示框", txt)
                tab3.handle_alert(accept=False)
                tab3 = browser3.new_tab()
            ...
            try:
                ...
                tab4.wait(1)
                # 提示框
                txt = tab4.handle_alert()
                print("提示框", txt)
                tab4.handle_alert(accept=False)
                tab4 = browser4.new_tab()
            ...
            try:
                ...
                tab5.wait(1)
                # 提示框
                txt = tab5.handle_alert()
                print("提示框", txt)
                tab5.handle_alert(accept=False)
                tab5 = browser5.new_tab()
            ...
            try:
                ...
                tab6.wait(1)
                # 提示框
                txt = tab6.handle_alert()
                print("提示框", txt)
                tab6.handle_alert(accept=False)
                tab6 = browser6.new_tab()
            ...
            try:
                ...
                tab7.wait(1)
                # 提示框
                txt = tab7.handle_alert()
                print("提示框", txt)
                tab7.handle_alert(accept=False)
                tab7 = browser7.new_tab()
            ...
            try:
                ...
                tab8.wait(1)
                # 提示框
                txt = tab8.handle_alert()
                print("提示框", txt)
                tab8.handle_alert(accept=False)
                tab8 = browser8.new_tab()
            ...
            try:
                ...
                tab9.wait(1)
                # 提示框
                txt = tab9.handle_alert()
                print("提示框", txt)
                tab9.handle_alert(accept=False)
                tab9 = browser9.new_tab()
            ...
            try:
                ...
                tab10.wait(1)
                # 提示框
                txt = tab10.handle_alert()
                print("提示框", txt)
                tab10.handle_alert(accept=False)
                tab10 = browser10.new_tab()
...
def proxy_pool(colist):
    ...
    try:
        ...
        # browser.ele('@id:onetrust-accept-btn-handler').click()
