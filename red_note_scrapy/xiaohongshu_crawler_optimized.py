...
class XiaoHongShuCrawler:
    ...
    def _generate_xs_common(self):
        ...
        base_part = ""
    ...
    def _prepare_headers(self, url):
        ...
        headers['cookie'] = (
            ...
            f"acw_tc={self.cookie_info['acw_tc']}; "
            f"websectiga={self.cookie_info['websectiga']}; "
            f"sec_poison_id={self.cookie_info['sec_poison_id']}; "
...
def main():
    ...
    if comments:
        ...
        # 统计子评论总数
        total_sub_comments = sum(len(comment['sub_comments']) for comment in comments)
        print(f"共获取到 {total_sub_comments} 条子评论")
        print(f"总计: {len(comments) + total_sub_comments} 条评论")
